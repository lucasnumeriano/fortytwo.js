...
import { selectElement } from "../core/Dom.mjs";

const bOpenMenu = selectElement('#button-open-menu');
const bCloseMenu = selectElement('#button-close-menu');

const nList = selectElement('.navlist');
